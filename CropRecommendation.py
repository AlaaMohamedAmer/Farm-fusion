...
model_path = r'C:\Users\Eman Yaser\Documents\4th FCIS\AI 2\project\Farm Fusion\CropPrediction.sav'  # Replace with your model's path
with open(model_path, 'rb') as file:
    model = pickle.load(file)

scaler_path = r'C:\Users\Eman Yaser\Documents\4th FCIS\AI 2\project\Farm Fusion\MinMaxScaler.sav'  # Replace with your scaler's path
